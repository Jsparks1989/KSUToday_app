    ...
    <div class="sidebar right" id="sidebar">
        <div class="secondary_nav">
            ...
            <ul>
                ...
                <!-- <li><p style="color: #007A95; font: 16.32px Arial, Helvetica, sans-serif; padding: 10.88px 6.3875px">Logged in as {{ Auth::user()->name }}</p></li> -->
                <li class="sidebar-user sidebar-font">Logged in as <span class="bold">{{ Auth::user()->name }}</span></li>
