...
//            });
    ...
    <link href="{{asset('css/app-master.css')}}" rel="stylesheet">
...
<div class="inner_rim page">
                   ...
                   <div class="sidebar right">
                    ...
                    @yield('main')
                        ...
                        <p><strong>PRESIDENT DANIEL S. PAPP, Ph.D.<br>
                        President, Kennesaw State University</strong></p>
                        
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste dolorem ipsum asperiores sapiente soluta, deleniti quam. Necessitatibus odio, praesentium, non minima repudiandae consequatur ullam unde facilis omnis reprehenderit deleniti et.</p>
