...
<script src="https://cdn.tiny.cloud/1/1v7knrx8m7z8k6gu5cozatz30kuypsr8ve5rq3853n67wawx/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
  ...
  tinymce.init({
    ...
    <h1>Contributor Create Post</h1>

    <div>
        <?php if(session('post-created-message')): ?>
            <div><h4 class="success"><?php echo e(session('post-created-message')); ?></h4></div>
        <?php endif; ?>
    </div>

    <form action="<?php echo e(route('contributor.store-post')); ?>" method="POST" id="createPost" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" formaction="<?php echo e(route('contributor.post-preview')); ?>" class="">Preview</button>
    </form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('contributor.contributor-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/contributor/contributor-create-post.blade.php ENDPATH**/ ?>