...
<div>
        ...
        <a href="<?php echo e(route('contributor.store-preview-post' )); ?>"><button>Save</button></a>
        
    </div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('contributor.contributor-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/contributor/contributor-preview-post.blade.php ENDPATH**/ ?>