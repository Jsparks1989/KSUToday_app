...
<?php $__env->startSection('main'); ?>
    ...
    <form action="<?php echo e(route('home.read-post-submit')); ?>" method="get"  enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        <div>
        ...
        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="li-wrapper">
                ...
                <div class="post-list-content">
                    ...
                    <p class="post-list-read-more"><a href="<?php echo e(route('home.show-post', $post->id)); ?>">Read More &rarr;</a></p>
...
<?php echo $__env->make('user.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\resources\views/user/user-read-all-posts.blade.php ENDPATH**/ ?>