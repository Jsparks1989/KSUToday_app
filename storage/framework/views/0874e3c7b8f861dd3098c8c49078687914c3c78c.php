...
<?php $__env->startSection('main'); ?>
    ...
    <h1>moderator Create Post</h1>

    <form action="<?php echo e(route('moderator.store-post')); ?>" method="POST" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" formaction="<?php echo e(route('moderator.create-post-preview')); ?>" class="">Preview</button>
    </form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('moderator.moderator-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/moderator/moderator-create-post.blade.php ENDPATH**/ ?>