...
<?php $__env->startSection('main'); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            let post_category_id = '<?php echo e($post->category_id); ?>';
            window.onload = onPageLoad();
            function onPageLoad(){
                // document.getElementsByClassName('categories').getElementById('<?php echo e($post->category_id); ?>')[0].checked = true;
                // document.getElementsByClassName('topics').getElementById('<?php echo e($post->topic_id); ?>').checked = true;
                ...
                // document.getElementById('<?php echo e($post->approved); ?>').checked = true;
            }
    ...
    <form action="<?php echo e(route('admin.update-post', $post->id)); ?>" method="POST" id="editPost" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="">
            ...
            <div><img src="<?php echo e('/storage/' . $post->image); ?>" alt="temporary image placeholder"></div>
            <input type="file" 
                   name="image" 
                   id="image"
                   class="">
...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" formaction="<?php echo e(route('admin.edit-post-preview', $post->id)); ?>" class="">Preview</button>
...
<?php echo $__env->make('admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/admin/admin-edit-posts.blade.php ENDPATH**/ ?>