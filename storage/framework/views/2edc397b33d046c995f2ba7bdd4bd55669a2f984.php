...
unset($__errorArgs, $__bag); ?>
        ...
        <button type="submit" formaction="<?php echo e(route('admin.create-post-preview')); ?>" class="">Preview</button>
    </form>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/admin/admin-create-post.blade.php ENDPATH**/ ?>