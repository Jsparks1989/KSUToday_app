...
<!-- ===================== JQuery Notes ===================== -->
<!-- Get element based on name attribute: element[name="element_name"]  -->
<!-- Get the element by name that was clicked/checked by user: element[name="element_name"]:checked -->
<!-- Get the element by name that was clicked/checked by user & get an attribute of that element: $('option[name="category_id"]:checked').attr('id') -->
<!--  -->
<!--  -->
...
<script>
    ...
    <h1>Contributor: Read All Posts page</h1>
            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="postItem">
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('contributor.show-post', $post->id)); ?>">Read More &rarr;</a>
                    </div>
...
<?php echo $__env->make('contributor.contributor-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\ksut\resources\views/contributor/contributor-read-all-posts.blade.php ENDPATH**/ ?>