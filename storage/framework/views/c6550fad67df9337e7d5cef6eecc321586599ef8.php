...
<script>
    ...
    <form action="<?php echo e(route('moderator.read-post-submit')); ?>" method="get" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="li-wrapper">
                    ...
                    <div class="post-list-content">
                        <h2><a href="<?php echo e(route('moderator.show-post', $post->id)); ?>"><?php echo e($post->title); ?></a></h2>
                        ...
                        <p class="post-list-read-more"><a href="<?php echo e(route('moderator.show-post', $post->id)); ?>">Read More &rarr;</a></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('moderator.moderator-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\KSUT_route_middleware_auth_repo\resources\views/moderator/moderator-read-all-posts.blade.php ENDPATH**/ ?>